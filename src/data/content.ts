...
// 자주 묻는 질문 (사용자 + 생성형 AI 검색 노출용 FAQPage)
export const faqs = [
  {
    q: '기찰반점 창업 비용은 얼마인가요?',
    a: '66㎡(20평) 기준 약 8,560만원입니다(점포 임대료 별도). 가입비 550만원, 교육비 330만원, 계약이행보증금 200만원에 인테리어·간판·주방기기·초도물품 등 시설비가 포함됩니다. 실제 금액은 매장 실측 후 확정됩니다.',
  },
  {
    q: '가맹 계약부터 매장 오픈까지 얼마나 걸리나요?',
    a: '상담일로부터 매장 오픈까지 약 45일이 소요됩니다. 상담·계약(정보공개서 제공 14일 후 계약) → 점포 실측·설계 → 인테리어 공사(약 20일) → 개점 교육(약 10일) → 오픈 순으로 진행됩니다.',
  },
  {
    q: '중식 조리 경험이 없어도 창업할 수 있나요?',
    a: '네, 가능합니다. 가맹본부가 핵심 소스를 자체 제조해 공급하고 표준 레시피와 개점 전 조리·서비스·운영 교육을 제공하므로, 외식업 경험이 없어도 매장을 운영할 수 있습니다.',
  },
  {
    q: '기찰반점은 어떤 브랜드인가요?',
    a: '기찰반점은 1인 9,900원대부터 즐기는 중식 무한리필 뷔페 프랜차이즈입니다. 낮에는 한·중·일 식사뷔페, 저녁에는 중식 주점뷔페로 운영되는 듀얼 수익구조가 특징이며, 가맹본부는 바른미식입니다.',
  },
  {
    q: '기찰반점 매장은 어디에 있나요?',
    a: '부산 구서본점·신라대점, 부산 기장 정관점, 경남 김해외동점, 경북 포항북구점 등 부산·경남·경북 지역에서 운영 중이며 지속 확장하고 있습니다.',
  },
  {
    q: '가맹 문의는 어떻게 하나요?',
    a: '가맹본부 대표번호 1600-5392로 전화하시거나, 홈페이지 가맹문의 폼을 통해 신청하시면 담당자가 빠르게 연락드립니다.',
  },
]
